!function(e, n) {
    ...
    var e = "WebkitAppearance"in document.documentElement.style ? "-webkit-" : ""
      ...
      , f = function(e) {
        ...
        return t.some(function(t) {
            if (void 0 !== e.style[t])
                return n.transitionProp = t,
                n.transEndEvent = r[t],
                !0
        }),
        o.some(function(t) {
            if (void 0 !== e.style[t])
                return n.transformProp = t,
                n.transformCssProp = t.replace(/(.*)Transform/, "-$1-transform"),
                !0
        }),
        n
    }
      ...
      , p = function(e, n) {
        for (var t = e.length, o = e[0], r = t > 1, i = c.scaleExtra, a = e.length, s = 0, l = 0, d = {
            ...
            s += g,
            l += p,
            r && (g < d.x ? d.x = g : g > f.x && (f.x = g),
            p < d.y ? d.y = p : p > f.y && (f.y = p))
        }
        if (r) {
            var y = f.x - d.x
              , b = f.y - d.y;
      ...
      , P = {
        click: function(e) {
            e.preventDefault(),
            w ? L ? R.close() : R.release() : R.open(e.currentTarget)
        },
        scroll: function() {
            var e = r();
            null === k && (k = e);
            var n = k - e;
            Math.abs(n) >= c.scrollThreshold && (k = null,
            R.close())
        },
        keydown: function(e) {
            var n = e.key || e.code;
        ...
        touchend: function(e) {
            e.targetTouches.length > 0 || (clearTimeout(A),
            L ? R.close() : R.release())
        }
    }
      , R = {
        listen: function(e) {
            if ("string" == typeof e) {
                for (var n = document.querySelectorAll(e), t = n.length; t--; )
                    R.listen(n[t]);
                return y
            }
            if ("IMG" === e.tagName)
                return e.style.cursor = d.cursor.zoomIn,
                e.addEventListener("click", P.click),
                c.preloadImage && e.hasAttribute("data-original") && o(e.getAttribute("data-original")),
                y
        },
        config: function(e) {
            if (!e)
        ...
        open: function(e) {
            ...
            if (!w && !T && (x = "string" == typeof e ? document.querySelector(e) : e,
            "IMG" === x.tagName)) {
                c.onBeforeOpen && c.onBeforeOpen(x),
                w = !0,
                T = !0,
                E = x.parentNode,
                !c.preloadImage && x.hasAttribute("data-original") && o(x.getAttribute("data-original"));
                ...
                d.target.close = M(x, d.target.open, !0),
                E.appendChild(h),
                setTimeout(function() {
                    return h.style.opacity = c.bgOpacity
                }, 30),
                document.addEventListener("scroll", P.scroll),
                document.addEventListener("keydown", P.keydown),
                x.addEventListener(G, function e() {
                    x.removeEventListener(G, e),
                    T = !1,
                    c.enableGrab && a(document, l, P, !0),
                    x.hasAttribute("data-original") && !function() {
        ...
        close: function() {
            ...
            if (w && !T)
                return c.onBeforeClose && c.onBeforeClose(x),
                T = !0,
                x.offsetWidth,
                b.style.cursor = d.cursor.default,
                h.style.opacity = 0,
                M(x, {
                    transform: "none"
                }),
                document.removeEventListener("scroll", P.scroll),
                document.removeEventListener("keydown", P.keydown),
                x.addEventListener(G, function n() {
                    x.removeEventListener(G, n),
                    w = !1,
                    T = !1,
                    c.enableGrab && a(document, l, P, !1),
                    x.hasAttribute("data-original") && x.setAttribute("src", z),
                    M(x, d.target.close),
                    E.removeChild(h),
                    e && e(x)
                }),
        ...
        grab: function(e, n) {
            var t = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : c.scaleExtra
              , o = arguments[3];
            if (w && !T) {
                c.onBeforeGrab && c.onBeforeGrab(x),
                L = !1;
                var r = i()
                  , a = r.x - e
                  , s = r.y - n;
        ...
        move: function(e, n) {
            var t = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : c.scaleExtra
              , o = arguments[3];
            if (w && !T) {
                c.onBeforeMove && c.onBeforeMove(x),
                L = !1;
                var r = i()
                  , a = r.x - e
                  , s = r.y - n;
        ...
        release: function() {
            ...
            if (w && !T)
                return c.onBeforeRelease && c.onBeforeRelease(x),
                T = !0,
                M(x, d.target.open),
                b.style.cursor = d.cursor.default,
                x.addEventListener(G, function n() {
    ...
    return M(h, d.overlay.init),
    h.setAttribute("id", "zoom-overlay"),
